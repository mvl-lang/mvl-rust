...
//!   tagged `mcdc__<id>__v<N>` (id = module path + decision-text
//!   hash, e.g. `btree_delete_f97051a9` for `if a && b` in
//!   `src/btree/delete.rs`; line-independent so unrelated edits don't retag) -- trusts a human/LLM wrote the vector, just
