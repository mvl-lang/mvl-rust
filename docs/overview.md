...
| This function has no obvious panic risk, and (if recursive) carries a decreases measure proved to strictly decrease for a small recognized shape set — see [Known Limitations](https://github.com/mvl-lang/mvl-rust/blob/main/.openspec/specs/003-function-contracts/spec.md#known-limitations) | [`rust-total`](https://docs.rs/rust-total) | `#[mvl::total]`, `#[mvl::decreases(measure)]` | |
